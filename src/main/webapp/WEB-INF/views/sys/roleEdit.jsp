	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var zNodes=[
					...
					{
						id: "${menu.id}",
						pId: "${empty menu.parent.id ? '0' : menu.parent.id}",
						name: "${menu.name}"
					},
					</c:forEach>
		            ];
			...
			var zNodes2=[
					...
					{
						id: "${office.id}",
						pId: "${empty office.parent.id ? '0' : office.parent.id}",
						name: "${office.name}"
					},
					</c:forEach>
		            ];
...
<body>
	...
	<form:form id="inputForm" cssClass="form-horizontal" modelAttribute="role"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="dataScope" cssClass="input-medium">
					<form:options items="${pm:getDictList('sys_data_scope')}" itemLabel="label" itemValue="value" />
				</form:select>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="remarks" maxlength="200" cssClass="input-xlarge" rows="3" id="remarks" />
			</div>
		</div>
